...
Through this laboratory activity, I learned how different types of cloud storage are used for different purposes. I also learned how to deploy MinIO using Docker, configure a container using environment variables, access a service through a forwarded port, create an object storage bucket, and upload files through a web-based cloud storage console.
